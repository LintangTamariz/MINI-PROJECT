    ...
    <div>
        ...
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <button
                    type="submit"
                    className="w-full text-white bg-[#F5B321] hover:bg-[#F5B321] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-[#F5B321] dark:hover:bg-[#F5B321] dark:focus:ring-blue-800"
                >
                    Sign in
                </button>
                <Link to={'/'}>
